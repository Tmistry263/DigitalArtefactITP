...
public class PersonalisedDigitalArtefact {
    ...
    public static void main(String[] args) {
        ...
        private static void displayPercentageOfTestsCompleted(int testsCurrentlyComplete, int totalOfTests, String testedProduct) {
        ...
        System.out.println("You have completed " + percentageTestsCompletedResult + " % of your testing on " + testedProduct);
